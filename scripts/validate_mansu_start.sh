...
assert_contains '| Hermes | OpenCode in tmux when detected | host-detected OpenCode skill dir | `omo` optional compatibility tooling |' "$FILE"
assert_contains '| OpenCode | `opencode` | host-detected OpenCode skill dir | `omo` optional compatibility tooling |' "$FILE"
