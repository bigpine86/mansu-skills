...
assert_contains 'source skill freshness for both gstack and Oh My / OMO / OMC' "$FILE"
...
assert_contains 'verify gstack and Oh My / OMO / OMC source freshness' "$OPENAI_YAML"
