...
require_ordered_terms "$DEFINE" 'define must route stale/broken Ouroboros to setup update/repair mode' 'public `mansu-9setup`' '`update`/`repair` mode' 'MCP integration'
