...
assert_contains 'checking VoltAgent/awesome-design-md freshness' "$FILE"
...
assert_contains 'verify Ouroboros, gstack, Oh My / OMO / OMC, addyosmani/agent-skills, and VoltAgent/awesome-design-md source freshness' "$OPENAI_YAML"
