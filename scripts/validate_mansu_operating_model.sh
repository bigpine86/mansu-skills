...
require_contains "$SOURCE_CATALOG" 'highest-priority runtime transport' 'source catalog lost LazyCodex runtime transport priority scope'
...
require_contains "$SOURCE_CATALOG" 'fallback compatibility' 'source catalog lost omx fallback route'
