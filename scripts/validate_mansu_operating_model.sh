...
require_contains "$SOURCE_CATALOG" 'mansu-setting source-check' 'source catalog lost read-only source-check default'
...
require_contains "$SOURCE_CATALOG" 'Mansu-setting prepares the host before project-start uses Ouroboros' 'source catalog lost Ouroboros setup route'
