...
assert_contains 'optionally preparing Open Design only when UI/design artifact work needs it or the user approves it' "$FILE"
assert_contains 'validating the source suite before sync and installed runtime copies after sync' "$FILE"
...
assert_contains 'checking VoltAgent/awesome-design-md and Open Design freshness' "$FILE"
