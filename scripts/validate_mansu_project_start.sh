...
grep -q 'Open Design for artifact generation when installed/approved' "$OPENAI_YAML"
grep -q 'gstack-design-consultation or gstack-design-shotgun' "$OPENAI_YAML"
grep -q 'gstack-plan-design-review or gstack-design-review' "$OPENAI_YAML"
