...
- Build: `mansu-build`는 기존 `mansu-tdd-total`을 계승하고, 구현 discipline은 addyosmani/gstack source skill 조합으로 잡는다. LazyCodex는 source skill family가 아니라 `mansu-setup`의 Codex-side OMO readiness로만 다룬다.
